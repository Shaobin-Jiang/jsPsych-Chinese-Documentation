...
???+ example "呈现问题，被试做出反应后消失"
    ...
    <a target="_blank" rel="noopener noreferrer" href="../../demos/jspsych-image-keyboard-response-demo1.html">在新标签页中打开</a>

???+ example "呈现图片一段时间；不接受反应"
    === "Code"
        ```javascript
        var trial = {
            type: jsPsychImageKeyboardResponse,
    ...
    <a target="_blank" rel="noopener noreferrer" href="../../demos/jspsych-image-keyboard-response-demo2.html">在新标签页中打开</a>
