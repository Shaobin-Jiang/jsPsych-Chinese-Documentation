...
???+ example "基本示例"
    ...
    <a target="_blank" rel="noopener noreferrer" href="../../demos/jspsych-categorize-animation-demo1.html">在新标签页中打开</a>
...
???+ example "使用`%ANS%`给予反馈"
    ...
    <a target="_blank" rel="noopener noreferrer" href="../../demos/jspsych-categorize-animation-demo2.html">在新标签页中打开</a>
